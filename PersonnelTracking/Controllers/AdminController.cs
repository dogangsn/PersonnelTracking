...
using SednaPersonel.Models.Models.PersonnelMonthlyInquiry;
using System;
...
namespace Kod_Yazilim_Personel.Controllers
{
    public class AdminController : Controller
    {
        ...
        SednaPersonel.Services.Services.CryptographyService _Cryptography;
        ...
        {
            _Cryptography = new SednaPersonel.Services.Services.CryptographyService();
        ...
        public ActionResult SalaryCalculator(int id , string donem, double Miktar)
        {
            ...
            foreach (var item in KayitListesi)
            {
                ...
                var kyt = new SednaPersonel.Models.Models.PersonnelMonthlyInquiry.SalaryCalculation
                {
                    salaryCalculationLists = new List<SednaPersonel.Models.Models.PersonnelMonthlyInquiry.SalaryCalculaterDetail>()
                };
                for (int i = 0; i < days; i++)
                {
                    DateTime day = d.AddDays(i);
                    ...
                    kyt.salaryCalculationLists.Add( new SednaPersonel.Models.Models.PersonnelMonthlyInquiry.SalaryCalculaterDetail { NetPrice = _netPrice});
